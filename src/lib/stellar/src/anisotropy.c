...
void (*stellartensorcallback)(starreal, starreal, starreal,  starreal[3][3]);
                  ...
                  starreal E[3][3])
{
    ...
    switch (improvebehave.tensor)
    {
        case NOTENSOR:
            ...
            break;
        case STRETCHX:
            scaletensor(100.0, 1.0, 1.0, E);  // default was 3 to 1
            break;
        case STRETCHY:
    ...
    switch (improvebehave.tensorb)
    {
        ...
        case RIGHT:
            ...
            break;
        case CUSTOM:
            stellartensorcallback(x, y, z,Eb);
            break;
        default:
            printf("Oops, don't know the tensor type %d, dying.\n", improvebehave.tensor);
            break;
